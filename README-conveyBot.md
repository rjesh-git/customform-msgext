...
3. Give the bot a handle (ex: `conveyBot`), choose your subscription and resource group
4. For the messaging endpoint, use this: `https://customformmsgext.azurewebsites.net/api/messages`
